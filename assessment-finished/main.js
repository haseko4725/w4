...
const storyText = 'その日は、とても暑かった。 なので :insertx: は散歩に出かけた。 彼らが :inserty:へ行ったとき、彼らはしばらく恐ろしそうに見つめていた, そして :insertz:。 Bob は全てを目の当たりにしたが驚くことはなかった。そう、:insertx: の体重は 300ポンド もあり、その日はとても暑かった。';
